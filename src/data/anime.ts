...
export const shelf: Anime[] = [
  ...
  },
  {
    ...
    "cover": "https://media.kitsu.app/anime/142/poster_image/f01d21998603a36c019211154074263a.jpg",
    "synopsis": "A calm village residing in the mountains comes under attack from a demon-possessed boar one day. Ashitaka, a young man and prince of the tribe, engages the creature in an attempt to save his village. During the battle, the boar bites him on the arm, leaving it blackened and cursed. Following his village's traditions, Ashitaka is exiled and becomes a wanderer, looking for a solution to the curse before it engulfs him. Iron Town is a fortress under the leadership of Lady Eboshi. Through the clearing of the surrounding forests, Iron Town produces large amounts of Ironsand, used for gunpowder and other machinery. How",
    "runtime": 130,
    "episodesWatched": 1,
    "totalEpisodes": 1,
    "status": "completed",
